  ...
  return (
    <div className='w-full h-screen bg-zinc-900 p-20 flex gap-5'>
        <div className="w-1/2 h-full flex flex-col justify-between">
            ...
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-6 '>Eye-</h1>
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-10 '>Opening</h1>
            </div>
        ...
        <div className="w-1/2">
        <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-7 '>Presentations</h1>
        <div className="dets mt-16">
            <a className='block text-xl font-light underline m-2' href="#">Facebook</a>
            <a className='block text-xl font-light underline m-2' href="#">Instagram</a>
            <a className='block text-xl font-light underline m-2' href="#">Discord</a>
            <a className='block text-xl font-light underline m-2' href="#">Twitter</a>
        </div>
        </div>
    </div>
  )
